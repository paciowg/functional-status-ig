...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationAdministration/f:performer">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/PACIO-functional-cognitive-status/StructureDefinition/obf-OnBehalfOf-extension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/PACIO-functional-cognitive-status/StructureDefinition/obf-OnBehalfOf-extension': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationAdministration/f:dosage">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/PACIO-functional-cognitive-status/StructureDefinition/obf-DoseSequenceNumber-extension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/PACIO-functional-cognitive-status/StructureDefinition/obf-DoseSequenceNumber-extension': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
