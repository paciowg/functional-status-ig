...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'documentReference']) &lt;= 1">extension with URL = 'documentReference': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'media']) &lt;= 1">extension with URL = 'media': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'questionnaireResponse']) &lt;= 1">extension with URL = 'questionnaireResponse': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'canonicalUrl']) &lt;= 1">extension with URL = 'canonicalUrl': maximum cardinality of 'extension' is 1</sch:assert>
