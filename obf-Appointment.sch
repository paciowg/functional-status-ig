...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Appointment">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/PACIO-functional-cognitive-status/StructureDefinition/obf-PatientInstruction-extension']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/PACIO-functional-cognitive-status/StructureDefinition/obf-PatientInstruction-extension': maximum cardinality of 'extension' is 1</sch:assert>
